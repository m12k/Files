...
namespace BTSS.Logic
{
	...
	internal partial class BTSSContext : System.Data.Linq.DataContext
	{
    ...
    partial void DeleteUserProject(UserProject instance);
		...
		[ResultType(typeof(GetActiveDirectoryGroupListResult))]
		public IMultipleResults GetActiveDirectoryGroupList([Parameter(DbType="VarChar(50)")] string domain)
		{
		...
		[Function(Name="dbo.GetUserPassword", IsComposable=true)]
		[return: Parameter(DbType="VarChar(50)")]
		public string GetUserPassword([Parameter(Name="UserName", DbType="VarChar(50)")] string userName)
		{
		...
		[Function(Name="dbo.IsDomainGroupExist", IsComposable=true)]
		[return: Parameter(DbType="Bit")]
		public System.Nullable<bool> IsDomainGroupExist([Parameter(Name="Name", DbType="VarChar(255)")] string name, [Parameter(Name="Domain", DbType="VarChar(50)")] string domain)
		{
			return ((System.Nullable<bool>)(this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), name, domain).ReturnValue));
		}
		...
		[return: Parameter(DbType="Bit")]
		public System.Nullable<bool> IsUserValid([Parameter(Name="UserName", DbType="VarChar(50)")] string userName)
		{
		...
		[return: Parameter(DbType="Int")]
		public int SaveUser([Parameter(Name="Id", DbType="VarChar(50)")] ref string id, [Parameter(Name="LastName", DbType="VarChar(50)")] string lastName, [Parameter(Name="FirstName", DbType="VarChar(50)")] string firstName, [Parameter(Name="MiddleName", DbType="VarChar(50)")] string middleName, [Parameter(Name="UserName", DbType="VarChar(50)")] string userName, [Parameter(Name="CreatedBy", DbType="VarChar(50)")] string createdBy, [Parameter(Name="Operation", DbType="VarChar(10)")] string operation)
		{
			IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), id, lastName, firstName, middleName, userName, createdBy, operation);
			id = ((string)(result.GetParameterValue(0)));
			return ((int)(result.ReturnValue));
		}
	...
	public partial class Sp_helpdiagramdefinitionResult
	{
		...
		[Column(Name="definition", Storage="_Definition", DbType="VarBinary(MAX)")]
