...
namespace Biztech
{
    public partial class FormAuditTrail : Form
    {
        ...
        private List<GetAuditListResult> data;
        ...
        private void Initialize()
        {
            try
            {
                ...
                auditTrail = new AuditTrail(Global.ConnectionString);
                LoadTree();
        ...
        private void LoadTree()
        {
            try
            { 
                List<string> users = auditTrail.GetUsers();
                ...
                List<string> tables = auditTrail.GetTables();
        ...
        private void RefreshListing()
        {
            ...
            { 
                ...
                data = auditTrail.GetAuditList(userName, tableName);
